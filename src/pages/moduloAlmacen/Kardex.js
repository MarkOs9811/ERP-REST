    ...
    <div className="row g-3">
      <div className="col-sm-12 col-md-6">
        <div className="card h-100 shadow-sm d-flex flex-row align-items-center justify-content-between p-3">
          ...
          <p className="mb-0 ms-2 text-center h3" style={{ color: "#0288D1" }}>
            Entradas
          </p>
          ...
          <div className="d-flex align-items-center">
            ...
            <button className="btn btn-sm">
              <DocumentTextOutline color="#0288D1" width="24px" height="24px" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm-12 col-md-6">
        <div className="card h-100 shadow-sm d-flex flex-row align-items-center justify-content-between p-3">
          ...
          <p className="mb-0 ms-2 text-center h3" style={{ color: "#7a5151" }}>
            Salidas
          </p>
          ...
          <div className="d-flex align-items-center">
            ...
            <button className="btn btn-sm">
              <DocumentTextOutline color="#D32F2F" width="24px" height="24px" />
            </button>
          </div>
        </div>
      </div>
