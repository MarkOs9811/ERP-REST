...
export const TicketImpresion = React.forwardRef((props, ref) => {
  const { venta } = props;
      ...
      {venta && (
        <div className="ticket-container">
          ...
          <div className="text-center">
            <h2 style={{ margin: "0", fontSize: "12pt" }}>Restaurante FIRE WOK</h2>
          ...
          <div style={{ fontSize: "8pt" }}>
            ...
            <p style={{ margin: "0" }}>
              CLIENTE: {venta.cliente?.nombre?.substring(0, 20)}
            </p>
