...
export function TransferirAlmacen() {
  ...
  return (
    <div className="row g-3 h-100">
        ...
        <div className="card border bg-light h-100">
          <div className="card-header d-flex align-content-between align-align-items-center border-bottom ">
            ...
            <div
              ...
              style={{ width: "300px" }}
            >
              <SearchOutline cssClasses="position-absolute  top-50 translate-middle-y text-muted ms-2" />
              <input
          ...
          <div
            className="card-body p-2 overflow-auto m-0"
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center gap-2 ">
                      ...
                      <div className="d-flex flex-column">
                        ...
                        <small className=" badge-info text-dark">
      ...
      <div className="col-lg-4 col-md-4 col-sm-12">
        <div className="card bg-light h-100 border">
