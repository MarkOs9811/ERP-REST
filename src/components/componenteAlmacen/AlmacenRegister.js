...
import { SaveOutline, SearchOutline } from 'react-ionicons';
    ...
    const fetchProveedores = async () => {
        try {
            ...
            if(response.data.success){
                ...
                const proveedorActivo = proveArray.filter(item => item.estado==='1');
    ...
    const onSubmit = async (data) => {
        try {
          ...
          if (error.response) {
            ...
            ToastAlert("error", error.response.data.message || "Error en el servidor");
    ...
    return (
        <div className="container p-0">
            <form id="productForm" onSubmit={handleSubmit(onSubmit)}>
                <div className=" shadow-card border-0 p-3">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <div className="form-floating mb-3">
                                    ...
                                    {errors.precioUnit && (
                                        <div className="invalid-feedback">{errors.precioUnit.message}</div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="col-md-4">
                                <div className="form-floating mb-3">
                                    <select
                                        ...
                                        id="unidad"
                                        {...register('unidad', { required: 'Este campo es obligatorio' })}
                                    >
                            ...
                            <div className="col-md-4">
                                <div className="form-floating mb-3">
                                    <select
                                        ...
                                        id="proveedor"
                                        {...register('proveedor', { required: 'Este campo es obligatorio' })}
                                    >
                        ...
                        <div className="form-floating mb-3">
                            <input
                                ...
                                {...register('pdf_file', { required: 'Este campo es obligatorio' })}
                            />
                            ...
                            <small className="alert" style={{ color: '#179e5b' }}>
                                <i className="fas fa-exclamation-circle"></i> Cargar archivo firmado por Administrador/Finanzas
                            </small>
                        </div>
                        ...
                        <div className="form-floating mb-3">
                            <input
                                ...
                                id="image_file"
                                accept="image/*"
                                {...register('image_file', { required: 'Este campo es obligatorio' })}
                            />
                        ...
                        <button type="submit" className="   p-3 btn-guardar">
                            <SaveOutline color={'auto'}/>
                            Guardar Registro
                        </button>
