  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row g-3">
        <div className="col-md-6">
          <div className="card border h-100">
            <div className="card-header">
              <p className="h6 mt-3">
                <DocumentAttachOutline color={"auto"} className={"me-2"} />
                Información General
              </p>
            </div>
            <div className="card-body d-flex flex-column align-items-center justify-content-center">
              <PersonOutline color={"auto"} height="50px" width="50px" />
        ...
        <div className="col-md-6">
          <div className="card border h-100">
            <div className="card-header">
              <p className=" h6 mt-3">
                <CubeOutline color={"auto"} className={"me-2"} /> Detalles del
                Producto
              </p>
            </div>
        ...
        <div className="col-md-12">
          <div className="card border h-100">
            <div className="card-header">
              <p className="h6 mt-3">
                <InformationCircleOutline color={"auto"} className={"me-2"} />{" "}
      ...
      <div className="modal-footer mt-2 border-0">
        <button
          type="button"
          className="btn btn-primary p-3 float-start me-auto"
        >
          <PrintOutline color={"auto"} /> Imprimir
        </button>
        {data?.estado == 1 ? (
          <h4>
            <CheckmarkDoneOutline color={"auto"} /> Atendido
          </h4>
        ) : (
          <button
            type="button"
