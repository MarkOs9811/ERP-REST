...
export function AlmacenStockAdd({
  handleCloseModal,
  producto,
  onAlmacenUpdate,
}) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        "http://erp-api.test/api/almacen/add-stock",
        formData,
        {
          headers: {
  ...
  return (
    <div className="p-3">
      ...
      >
        ...
        La información del documento debe reflejarse aquí. Para agregar un nuevo
        producto, ingrese{" "}
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-3">
          ...
          <div className="input-group">
            <input
              ...
              id="nuevaCantidad"
              className={`form-control ${
                cantidadError ? "is-invalid" : "input-add-stock"
              }`}
            ...
            {cantidadError && (
              <div className="invalid-feedback">
                <i className="fas fa-exclamation-circle"></i> La cantidad
                ingresada es inválida.
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            {...register("pdf", {
              ...
              validate: (value) =>
                value?.length > 0 || "Debe cargar un archivo PDF",
            })}
          ...
          <small className="text-success">
            <i className="fas fa-info-circle"></i> Cargar archivo firmado por
        ...
        <div className="mb-3">
          ...
          <input
            ...
            {...register("firma", {
              ...
              validate: (value) =>
                value?.length > 0 || "Debe cargar una imagen de firma",
            })}
            onChange={(e) => setImageFile(e.target.files[0])}
          />
          {errors.firma && (
            <p className="text-danger">{errors.firma.message}</p>
          )}
        ...
        <div className="d-flex justify-content-end">
          <button
            type="button"
            className="btn-cerrar-modal me-2 rounded-pill"
            onClick={handleCloseModal}
          >
            <i className="fas fa-times"></i> Cerrar
          </button>
          <button type="submit" className="btn-guardar rounded-pill">
