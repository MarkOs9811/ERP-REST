...
export function NuevoCombo({ onClose, onSuccess }) {
  ...
  const iconos = {
    Bebidas: <WineOutline className="me-2" />,
    Platos: <RestaurantOutline className="me-2" />,
    Brasa: <FlameOutline className="me-2" />,
    Hamburguesa: <FastFoodOutline className="me-2" />,
  };
            ...
            <div className="d-flex justify-content-start align-items-center mb-4 flex-column">
              ...
              >
                {bloqueado ? (
                  ...
                  <>
                    <ColorWandOutline className="me-2" color={"auto"} />
