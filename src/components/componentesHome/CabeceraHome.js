...
import { GridOutline, PersonOutline, PulseOutline } from "react-ionicons";
import { getVentas } from "../../service/ObtenerVentasDetalle";

export function CabeceraHome({ ventasList }) {
  ...
  return (
    <div className="row mb-3 g-3">
      <div className="col-md-6 col-sm-12">
        {/* Header Bienvenida */}
        <div
          className="dashboard-card dashboard position-relative h-100"
          style={{
        ...
        >
          ...
          >
            ...
            <button className="btn btn-danger">Iniciar</button>
            <PersonOutline
              color={"#fff"}
              height="30px"
              width="30px"
            ...
            <div className="d-flex align-items-center mt-2">
              <PulseOutline color={"#fff"} height="18px" width="18px" />
